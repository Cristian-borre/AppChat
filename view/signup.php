                ...
                <div class="body">
                    <div class="row g-2 mb-4 mt-4">
                        <div class="col form-floating">
                            <input type="text" class="form-control" placeholder="Name" name="name" id="Inputname">
                    ...
                    <div class="form-floating mb-4">
                        <input type="text" class="form-control" placeholder="Username" name="username" id="InputUsername">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" class="form-control" placeholder="Picture" name="img" id="InputPicture">
                    </div>
                </div>
                <div class="footer text-center">
                    <button type="button" class=" btn btn-dark mb-3 fs-5 w-75 mt-3" onclick="signup()">Sign Up</button>
                    <p>Ya tienes cuenta?? <a href="login.php">SignIn now</a></p>
                </div>
            </form>
        </div>
    </div>    
