...
<body class="m-0 row justify-content-center align-items-center">
        ...
        <div>
            <header class="header d-flex align-items-center mb-4 justify-content-between">
                <div class="content d-flex pt-3 pb-3">
                    <img src="../upload/<?=$user['img']?>" width="80" height="80" alt="">
            ...
            <div class="search input-group mb-3">
                <input type="text" class="form-control" id="searchtext" placeholder="Buscar un chat o inicia uno nuevo">
                <button class="btn btn-dark" id="searchbtn"><i class="bx bx-search"></i></button>
            </div>
            <div id="chatlist" class="user-list mb-2">
                <?php
    ...
    <script src="../assets/js/update_time.js"></script>
